class ChannelAdvisor
	...
	def initialize()
		@options = { header: {"APICredentials" => {'DeveloperKey' => ENV['channeladvisor_developer_key'], 'Password' => ENV['channeladvisor_password']}}, query: {'accountID' => ENV['channeladvisor_account_id'], 'sku' => "ACC-1"} }
	end
